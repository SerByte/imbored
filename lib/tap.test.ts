...
/**
 * Классы, из которых элемент получает собственную высоту: отступы, заданная
 * высота, позиционирование, скрытие. Такой элемент про зону попадания уже
 * подумал — кнопка с py-3 даёт 48 px и без утилиты.
 */
const SIZED =
  /\b(?:p|px|py|pt|pb|h|min-h|size|aspect|inset)-|\b(?:absolute|fixed|sr-only|hidden|block|inline-block|flex|grid)\b/

...
/**
 * Полка «Приглянулось»: сколько отдаёт сервер и сколько видно до «Показать
 * все». Потолок — ради веса ответа, а не ради полки: сто двадцать
 * приглянувшихся — это уже годы листания.
 */
export const EXPLORE_SHELF_MAX = 120
export const EXPLORE_SHELF_FOLD = 12

...
export function buildWarmPlan(
  ...
  // — и по УБЫВАНИЮ. Appid Steam раздаёт по порядку, так что больший — это
  // игра новее, чаще всего и купленная позже. По возрастанию у коллекционера
  // с тремя тысячами нераспакованных под потолок попадали релизы 2004–2012, а
  // свежие покупки не получали меты вовсе — и в «Ни разу не запускал» их не
  // было, если каталог до них не дошёл сам.

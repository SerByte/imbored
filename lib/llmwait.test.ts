 ...
 * SDK. В @anthropic-ai/sdk (так было в 0.116 и осталось в 0.128) повтор при
 * 429 спит ровно столько, сколько сказал заголовок retry-after, без потолка, и
 * повторяет запрос. С прежними настройками (30 с × 2 попытки) экран
 * «Подбираю…» стоял бы минуту и больше, а через восемь секунд могла приехать
 * бесплатная эвристика.
 *

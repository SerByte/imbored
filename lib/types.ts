...
export type ScoredCandidate = {
   ...
   * собираются руками. Изнанка скоринга: на экран не выводится нигде. Клиенту
   * /play уходит только округлённой копией для снимка к оценке (scoreView в
   * lib/cards.ts, lib/feedbackctx.ts) — самому человеку, по его сессии.
   */
  parts?: ScoreParts
}

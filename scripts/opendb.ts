 ...
 * описаний) выбор был такой: либо импортировать из чужого скрипта, либо
 * развести две копии чтения окружения, которые разъедутся при первой же
 * смене имени переменной.
 *

  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-2xl px-5 pt-28 pb-16 flex flex-col gap-8">
        ...
        <Section title="Портрет игрока и ссылки на него">
          <p>
            Страница портрета <span className="text-ink">публичная</span>: её видит любой, у кого
            есть ссылка. Когда такую ссылку отправляют в мессенджер или соцсеть, площадка сама
            запрашивает превью — картинку с именем профиля, обложками игр и числами из портрета.
          </p>
          <p>
